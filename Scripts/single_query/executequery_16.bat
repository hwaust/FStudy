...
set dbs=-dblist xmark1_16_20K:16
set f=-f g:\data\fragments\xmark1_16_20K_20171126

echo start
for %%i in (1 2 3 4 5 6) do (
echo java -Xmx6g -Xms6g -cp bxstudy.jar fragmentation.exe.QueryEvaluator %ips% %dbs% -key xm%%i.org %f% -sys linux
