...
\begin{table}[]
	...
	\begin{tabular}{|c|c|c|c|c|c|c|c|c|c|c|}
		\hline
		\multirow{2}{*}{Key} & \multirow{2}{*}{\begin{tabular}[c]{@{}c@{}}T$_p$\\ (s)\end{tabular}} & \multicolumn{5}{c|}{T$_s$ (s)} & \multirow{2}{*}{\begin{tabular}[c]{@{}c@{}} T$_m$ \\ (s)\end{tabular}} & \multirow{2}{*}{\begin{tabular}[c]{@{}c@{}}T$_o$\\ (s)\end{tabular}} & \multicolumn{2}{c|}{Results Size} \\ \cline{3-7} \cline{10-11} 
